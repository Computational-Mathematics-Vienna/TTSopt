...
% attraction' of a point in the basket
% function [xbest,fbest,xmin,fmi,nbasket,loc,flag] = basket(fcn,x,
...
function [xbest,fbest,xmin,fmi,x,f,loc,flag,ncall] = basket(fcn,x,f,xmin,fmi,xbest,fbest,stop,nbasket)
