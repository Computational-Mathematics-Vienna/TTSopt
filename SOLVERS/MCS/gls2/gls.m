...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% gls.m %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function [alist,flist,nf]=gls(fcn,xl,xu,x,p,alist,flist,nloc,small,smax,prt)
...
% xl,xu:	box [xl,xu] for x (may be single numbers)
% x: 		starting point
% p:		search direction
...
% adapt length of bound vectors
n=length(x);
if length(xl)==1, xl=xl+zeros(n,1); end;
if length(xu)==1, xu=xu+zeros(n,1); end;
