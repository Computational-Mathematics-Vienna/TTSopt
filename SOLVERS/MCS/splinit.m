...
% splinit(fcn,i,s,smax,par,x0,n0,u,v,x,y,x1,x2,L,l,xmin,fmi,xbest,
...
function [xbest,fbest,f0,xmin,fmi,ipar,level,ichild,f,flag,ncall] = splinit(fcn,i,s,smax,par,x0,n0,u,v,x,y,x1,x2,L,l,xmin,fmi,ipar,level,ichild,f,xbest,fbest,stop,prt)
global nbasket nboxes nglob nsweep nsweepbest record xglob xloc  
% nbasket   	counter for points in the basket
% nboxes      	counter for boxes outside the basket
