function [x, fmax, nf] = mdsmax(fun, x, stopit, options, savit, varargin)
...
if nargin < 4
   ...
   simplex_form = 0;  % initial simplex form
elseif isempty(options)
   ...
   mu = options.mu;
   theta = options.theta;
   simplex_form = options.simplex_form;
end
if nargin < 5, savit = []; end                   % File name for snapshots.
