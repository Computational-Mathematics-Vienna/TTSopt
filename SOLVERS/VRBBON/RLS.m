...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% RLS.m %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function [point,par,step,info] = RLS(fun,point,step,par,tune,info)
%
...
par.Iperm= randperm(point.n);par.ngood=0;
  ...
  case 1 % opposite direction
    ...
    if ext, par.state=0; continue;
        ...
        if par.state==0 
          ...
          [step]=reducedStepSize(step,par,tune); % reduce the step size
