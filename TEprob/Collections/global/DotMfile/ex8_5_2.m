...
% Objective
fun = @(x)log(x(1))*x(1)+log(x(2))*x(2)+log(x(3))*x(3)+x(6)/(x(4)-x(6))-log(x(4)-x(6))-2*x(5)/x(4)+0.585616681390832*x(1)+3.53797016206289*x(2)+2.18345516206289*x(3);
