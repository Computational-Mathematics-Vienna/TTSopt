...
nlcon = @(x)[(-2.35*x(1)*x(2))-10.7*x(1)-63.3*x(2)+10.9*x(1)*x(3)+93.5*x(3)+0.108*x(1)*x(4)-25.1*x(4)-76.8*x(2)*x(3)+37.9*x(2)*x(4)-9.31*x(3)*x(4)-0.295*x(1)^2+25.1*x(2)^2+30.4*x(3)^2-28.1*x(4)^2;
             ...
             x(4);
             x(4)];
cl = [-Inf,-Inf,-Inf,-Inf,-Inf,-Inf,-Inf,3,-Inf,1,-Inf,1,-Inf,1,-Inf]';
cu = [-70181,-35467,-41625,-166871,1101.76,507474,5,Inf,16,Inf,5,Inf,3,Inf,3]';
...
% Options
opts = struct('probname','inf_minlp_175');
opts.sense = 'max';
