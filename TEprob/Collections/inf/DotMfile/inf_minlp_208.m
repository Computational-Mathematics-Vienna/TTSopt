...
% File generated: 07-Jan-2016 10:23:33
% Model: inf_minlp_208
...
cu = [464,5197,173,25778,0.7772,-1.87,-414,-4997,-23,-25678,9.2228,5001.87,5,Inf,16,Inf,3,Inf,0,Inf,0]';
...
% Options
opts = struct('probname','inf_minlp_208');
opts.sense = 'max';
