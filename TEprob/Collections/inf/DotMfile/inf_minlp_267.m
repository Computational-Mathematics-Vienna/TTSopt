...
nlcon = @(x)[-(x(13)*x(1)+x(14)*x(1)+x(15)*x(1)+x(16)*x(1))+x(7);
             ...
             x(39)-(0.9*x(39)*x(75)+x(39)*(1-x(75)));
             x(43)-(0.9*x(43)*x(79)+x(43)*(1-x(79)));
             x(47)-(0.9*x(47)*x(83)+x(47)*(1-x(83)));
             x(40)-(0.9*x(40)*x(76)+x(40)*(1-x(76)));
             x(44)-(0.9*x(44)*x(80)+x(44)*(1-x(80)));
             x(48)-(0.9*x(48)*x(84)+x(48)*(1-x(84)))];
...
% Options
opts = struct('probname','inf_minlp_267');
opts.sense = 'max';
