...
% File generated: 07-Jan-2016 10:36:46
% Model: inf_minlp_278
...
cu = [464,5197,173,25778,0.7772,-1.87,-364,-5097,27,-25578,9.2228,5001.87,5,Inf,16,Inf,3,Inf,0,Inf,0]';
...
% Options
opts = struct('probname','inf_minlp_278');
opts.sense = 'max';
