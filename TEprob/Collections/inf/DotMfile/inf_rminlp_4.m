...
% File generated: 01-Jun-2015 14:42:08
% Model: inf_rminlp_4
...
cu = [464,5197,173,25778,0.7772,-1.87,-364,-5097,27,-25628,9.2228,5001.87,4,Inf,16,Inf,3,Inf,0,Inf,0]';
...
% Options
opts = struct('probname','inf_rminlp_4');
opts.sense = 'max';
