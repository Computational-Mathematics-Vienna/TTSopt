...
% File generated: 07-Jan-2016 15:17:13
% Model: inf_minlp_58
...
nlcon = @(x)[(-3*x(1)*x(2))-23*x(1)+118*x(2)+12*x(1)*x(3)+11*x(1)*x(4)-474*x(4)+196*x(2)*x(3)-180*x(2)*x(4)-8*x(3)*x(4)-19*x(2)^2-173*x(3)^2+207*x(4)^2;
             ...
             x(4);
             x(4)];
cl = [-Inf,-Inf,-Inf,-Inf,-Inf,-Inf,-100464,-105197,-100173,-125778,-100.7772,-98.13,-Inf,14,-Inf,1,-Inf,1,-Inf,1,-Inf]';
cu = [-17464,-22197,-42173,-61778,199.2228,201.97,Inf,Inf,Inf,Inf,Inf,Inf,50,Inf,16,Inf,3,Inf,3,Inf,3]';
...
% Options
opts = struct('probname','inf_minlp_58');
opts.sense = 'max';
