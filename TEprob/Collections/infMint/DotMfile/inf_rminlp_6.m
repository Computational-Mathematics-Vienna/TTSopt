...
nlcon = @(x)[-(-3*x(1)*x(2)-23*x(1)+118*x(2)+12*x(1)*x(3)+11*x(1)*x(4)-474*x(4)+196*x(2)*x(3)-180*x(2)*x(4)-8*x(3)*x(4)-19*x(2)^2-173*x(3)^2+207*x(4)^2)+x(5);
             ...
             x(4);
             -x(2)+x(4)];
cl = [464,5197,173,25778,0.7772,-1.87,-Inf,-Inf,-Inf,-Inf,-Inf,-Inf,-Inf,14,-Inf,2,-Inf,1,-Inf,1,-Inf]';
cu = [464,5197,173,25778,0.7772,-1.87,-364,-4997,127,-25678,9.2228,5001.87,5,Inf,16,Inf,3,Inf,0,Inf,0]';
...
% Options
opts = struct('probname','inf_rminlp_6');
opts.sense = 'max';
