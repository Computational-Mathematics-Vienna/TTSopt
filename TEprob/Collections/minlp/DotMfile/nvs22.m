...
% Bounds
lb = [1,1,1,1,-Inf,-Inf,-Inf,-Inf]';
ub = [200,200,20,20,Inf,Inf,Inf,Inf]';
...
nlcon = @(x)[-4243.28147100424/(x(3)*x(4))+x(5);
             ...
             -504000/(x(1)^2*x(2));
             x(2)-x(3);
             0.0204744897959184*(10000000000000*x(2)^3*x(1)*x(1)*x(2)^3)^0.5*(1-0.0282346219657891*x(1));
             -2.1952/(x(1)^3*x(2))];
