...
% File generated: 31-Jan-2014 00:59:57
% Model: grasp
...
nlcon = @(x)[x(1)+0.493101233652021*x(36)+0.770039499372672*x(41)-0.404833722380856*x(46);
             ...
             -x(4)+x(51);
             -x(5)+x(51);
             ((x(6)^2+x(11)^2+x(16)^2)^0.5)^0.5-(0.3*x(1))^0.5;
             ((x(7)^2+x(12)^2+x(17)^2)^0.5)^0.5-(0.3*x(2))^0.5;
             ((x(8)^2+x(13)^2+x(18)^2)^0.5)^0.5-(0.3*x(3))^0.5;
             ((x(9)^2+x(14)^2+x(19)^2)^0.5)^0.5-(0.3*x(4))^0.5;
             ((x(10)^2+x(15)^2+x(20)^2)^0.5)^0.5-(0.3*x(5))^0.5;
