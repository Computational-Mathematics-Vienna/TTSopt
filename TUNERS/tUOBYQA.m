...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% tUOBYQA generates necessary data for doing tuning the parameters
% of UOBYQA by a mixed integer solver
%
...
%
% solverParams = struct('rhobeg',1.0, 'rhoend',1e-06)


function tuneinfo = tUOBYQA
  ...
  x(1).Values.upp = 10;
  x(1).Current = 1.0;
  x(1).Type = 'continuous'; % rhobeg (continuous)
  x(2).Values.low = 1e-08;
  x(2).Values.upp = 0.0001;
  x(2).Current = 1e-06;
  x(2).Type = 'continuous'; % rhoend (continuous)
