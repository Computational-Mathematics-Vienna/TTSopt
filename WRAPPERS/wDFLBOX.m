...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% function output = wDFLBOX(prob, func, options)
%
% wrapper for the DFLBOX solver
%
%
% ARGUMENTS
% ---------
...
function output = wDFLBOX(prob, func, options)
  ...
  solverParams = {};
  solverParams{1} = struct('eta',1e-06);
...
'  .funInfo (structure): additional info'...
    ...
    otherwise % all arguments -> calls the solver and returns its output
      ...
      if TuneCase > 0, solname = ['DFLBOX',num2str(TuneCase)];
      else, solname = 'DFLBOX';
      end
