...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% function output = wFMAES(prob, func, options)
%
% wrapper for the FMAES solver
%
%
% ARGUMENTS
% ---------
...
%
%     .sigma_init (int): 0
%       sigma_init=sigma_init_coeff1+sigma_init_coeff2*log(n) is the
%       initial mutation stregth
%
%
% RETURNS
% -------
...
function output = wFMAES(prob, func, options)
  ...
  solverParams = {};
  solverParams{1} = struct('lambda',20, 'mu',10, 'sigma_init',0);
...
'  .funInfo (structure): additional info'...
    ...
    otherwise % all arguments -> calls the solver and returns its output
      ...
      if TuneCase > 0, solname = ['FMAES',num2str(TuneCase)];
      else, solname = 'FMAES';
      end
