...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% function output = wLMMAES(prob, func, options)
%
% wrapper for the LMMAES solver
%
%
% ARGUMENTS
% ---------
...
%
%     .gamma (int): 20
%       number of path vectors used
%
%     .sigma_init_coeff1 (float): 1.0
%       coefficient 1 for initial mutation stregth sigma
%
%     .sigma_init_coeff2 (float): 1.0
%       coefficient 2 for initial mutation stregth sigma
%
%
% RETURNS
% -------
...
function output = wLMMAES(prob, func, options)
  ...
  solverParams = {};
  solverParams{1} = struct('lambda',20, 'mu',10, 'gamma',20,...
...
'  .funInfo (structure): additional info'...
    ...
    otherwise % all arguments -> calls the solver and returns its output
      ...
      if TuneCase > 0, solname = ['LMMAES',num2str(TuneCase)];
      else, solname = 'LMMAES';
      end
