...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% function output = wMATRS(prob, func, options)
%
% wrapper for the MATRS solver
%
%
% ARGUMENTS
% ---------
...
function output = wMATRS(prob, func, options)
  ...
  badCaseMsg = '%d is not a valid option case. Must be an integer in [-1, 0].';
...
'  .funInfo (structure): additional info'...
    ...
    otherwise % all arguments -> calls the solver and returns its output
      ...
      if TuneCase > 0, solname = ['MATRS',num2str(TuneCase)];
      else, solname = 'MATRS';
      end
