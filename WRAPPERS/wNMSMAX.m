...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% function output = wNMSMAX(prob, func, options)
%
% wrapper for the NMSMAX solver
%
%
% ARGUMENTS
% ---------
...
function output = wNMSMAX(prob, func, options)
  ...
  solverParams = {};
  solverParams{1} = struct('simplex_form',0);
...
'  .funInfo (structure): additional info'...
    ...
    otherwise % all arguments -> calls the solver and returns its output
      ...
      if TuneCase > 0, solname = ['NMSMAX',num2str(TuneCase)];
      else, solname = 'NMSMAX';
      end
