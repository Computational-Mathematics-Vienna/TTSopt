...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% function output = wSDBOX(prob, func, options)
%
% wrapper for the SDBOX solver
%
%
% ARGUMENTS
% ---------
...
function output = wSDBOX(prob, func, options)
  ...
  solverParams = {};
  solverParams{1} = struct('gamma',1e-06, 'theta',0.5);
...
'  .funInfo (structure): additional info'...
    ...
    otherwise % all arguments -> calls the solver and returns its output
      ...
      if TuneCase > 0, solname = ['SDBOX',num2str(TuneCase)];
      else, solname = 'SDBOX';
      end
      ...
      % adds paths
      eval(['addpath ',SOLpath,'/SDBOX/MATLAB2']);
